...
private extension BrewPackagesTracker
{
    ...
    func checkForDynamicPackageByID(passedInPackage package: BrewPackage) -> BrewPackage?
    {
        ...
        {
            AppConstants.shared.logger.debug("Found the correct formula: \(possibleFormula.name(withPrecision: .precise)), ID: \(possibleFormula.id)")
        ...
        {
            AppConstants.shared.logger.debug("Found the correct cask: \(possibleCask.name(withPrecision: .precise)), ID: \(possibleCask.id)")
    ...
    func checkForDynamicPackageByMinimalHashableRepresentation(passedInPackage package: BrewPackage) -> BrewPackage?
    {
        ...
        struct FastPackageComparableRepresentation: Hashable
        {
            ...
            {
                self.init(name: brewPackage.name(withPrecision: .precise), type: brewPackage.type, versions: brewPackage.versions)
            }
        }
        ...
        {
            AppConstants.shared.logger.debug("Found the correct Formula using hashing: \(possibleFormula.name(withPrecision: .precise)), ID: \(possibleFormula.id)")
            return possibleFormula
        }
        ...
        {
            AppConstants.shared.logger.debug("Found the correct Cask using hashing: \(possibleCask.name(withPrecision: .precise)), ID: \(possibleCask.id)")

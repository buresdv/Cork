...
func tagPackage(package: BrewPackage, brewData: BrewDataStorage, appState: AppState) async -> Void
{
    if !package.isCask
    {
        ...
        {
            brewData.installedFormulae[indexToReplace] = BrewPackage(name: package.name, isCask: package.isCask, isTagged: true, installedOn: package.installedOn, versions: package.versions, sizeInBytes: package.sizeInBytes)
        }
